            ...
            <div class="e-con-inner">
                <div
                    ...
                    <div class="elementor-element elementor-element-ae139d8 elementor-widget elementor-widget-heading"
                         data-id="ae139d8" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                            <h4 class="elementor-heading-title elementor-size-default">Certified Plastic Recovery and Carbon Credits (In Progress)</h4>
                        </div>
                    </div>
                    <div
                        class="elementor-element elementor-element-72c039b8 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
                        data-id="72c039b8" data-element_type="widget" data-widget_type="text-editor.default">
                        <div class="elementor-widget-container">
                            <p>KALTANI is currently undergoing registration and third-party verification to issue high <strong> integrity carbon credits under Article 6, and plastic credits under Verra’s Gold
                                    Standard for plastic recovery</strong></p>


                            Once certified, these credits will be generated by:
                            ...
                            <ul style="margin-left: -35px; margin-top: 10px">
                                <li>
                                    ...
                                    <strong>Collecting, sorting, and processing</strong> plastic waste that would otherwise pollute the
                                    environment </li>
                                <li>
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_5870_3496)">
                                   ...
                                   <strong> Diverting waste</strong>e from open dumps and reducing <strong>methane and CO₂ emissions</strong>  through
                                    recycling and RDF-based waste-to-energy systems </li>
                ...
                <div
                    ...
                    <div class="elementor-element elementor-element-ae139d8 elementor-widget elementor-widget-heading"
                         data-id="ae139d8" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                            <h4 class="elementor-heading-title elementor-size-default">Built on rigorous MRV (Measurement, Reporting, and Verification) frameworks, our credits will
                                offer:</h4>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="elementor-widget-container">
                            ...
                            <ul style="margin-left: -35px; margin-top: 10px">
                                ...
                                <li>
                                    ...
                                    Traceable, verifiable recovery operations</li>
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Verified emission reductions that meet global carbon market compliance</li>
                                ...
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Scalable climate financing opportunities for local governments</li>
                                ...
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Meaningful ESG contributions for climate-conscious partner</li>
                                ...
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    The awards have been updated and it’s on page 4 of company profile</li>
                                ...
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Include all our services written in the document sent</li>
                                ...
                                <li> <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    Include partners. Partners can be found on partner slide on company profile</li>
                            </ul>
